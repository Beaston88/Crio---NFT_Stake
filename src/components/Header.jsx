...
export default function Header(){
  return (
    <header>
      <nav className="w-full h-20 bg-black opacity-90">
        <div className="flex items-center justify-between">
          <div className="flex">
            ...
            <div className="hidden lg:flex sm:items-center">
              <div className="relative group">
                <div className="text-white hover:text-yellow-400 text-md mx-3">
                  Buy Crypto
                </div>
              </div>
              <div className="relative group">
                <div className="text-white hover:text-yellow-400 text-md mx-3">
                  Markets <i className="fa-solid fa-angle-down"></i>
                </div>
              ...
              <div className="relative group">
                <div className="text-white hover:text-yellow-400 text-md mx-3">
                  Trade <i className="fa-solid fa-angle-down"></i>
                </div>
                <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                  <div className="py-1">
                    <a
              ...
              <div className="relative group">
                <div className="text-white hover:text-yellow-400 text-md mx-3">
                  Earn <i className="fa-solid fa-angle-down"></i>
                </div>
                <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                  <div className="py-1">
                    <a
          ...
          <div className="flex items-center justify-end ">
            <div className="text-white hover:text-yellow-300 text-md mx-3">
              <i className="fa-solid fa-magnifying-glass"></i>
            </div>
            <div>
              <button className="bg-gray-700 font-semibold p-2 text-1xl mx-2 rounded-md text-white">
                Log In
              </button>
            </div>
            <div>
              <button className="bg-yellow-600 font-semibold p-2 text-1xl mx-2 rounded-md text-black">
                Sign Up
              </button>
            </div>
      ...
      {/* <div className="w-full h-14 bg-transparent flex items-center ">
        <div className="flex items-center w-5/6 justify-between">
          ...
          <div className="flex justify-start w-5/6">
            ...
            <div className="flex items-center border-2 border-yellow-400 text-2xl hidden md:flex">
